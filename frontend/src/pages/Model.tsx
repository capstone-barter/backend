    ...
    <>
      ...
      <div className="mr-20 ml-20">
        <div className="w-full flex flex-col items-center">
          <h1
            className="ml-7 mr-7 pt-9 mb-5 text-6xl font-bold leading-none tracking-normal text-purple-950 md:text-5xl lg:text-6xl text-center pt-5 pr-3 pl-3 ps-px"
            style={{ width: "80%" }}
          >
            Data Optimization at the Heart of <span className="text-pink-500">Innovation</span> and{" "}
            <span className="text-pink-500">Efficiency</span>{" "}
          </h1>
          <p
            className="text-lg font-normal text-gray-600 lg:text-xl text-center pr-3 pl-3"
            style={{ width: "70%" }}
          >
            The optimization model developed by the team aims at increasing the efficiency of the
            allocation of solar panels in Spain
          </p>
        </div>

        <hr className="w-48 h-1 mx-auto my-4 bg-purple-950 border-0 rounded md:my-10" />

        <h3 class="text-center pt-5 pb-2 text-3xl font-bold text-purple-950">Technologies used</h3>
        <div className="flex pr-4 pl-4">
          <div className="w-1/2 p-4 bg-purple-100 p-5 rounded-lg mt-5 shadow-md text-lg">
            The model has been developed using a plethora of different technologies. Given the
            quantity of data to work with, the team has uploaded the data in the{" "}
            <span className="text-pink-500 dark:text-pink-600">Microsoft Azure cloud</span> , in a{" "}
            <span className="text-pink-500 dark:text-pink-600">Data Lake</span>. In order to process
            the data, another offering of Azure has been utilized,{" "}
            <span className="text-pink-500 dark:text-pink-600">Databricks</span>. The data has later
            been processed in a Jupyter notebook using
            <span className="text-pink-500 dark:text-pink-600"> PySpark</span> and
            <span className="text-pink-500 dark:text-pink-600"> Pandas</span>. The web application
            has been developed using{" "}
            <span className="text-pink-500 dark:text-pink-600"> React.js</span>,
            <span className="text-pink-500 dark:text-pink-600"> Tailwind CSS</span> , and
            <span className="text-pink-500 dark:text-pink-600"> Mapbox GL</span>{" "}
          </div>
